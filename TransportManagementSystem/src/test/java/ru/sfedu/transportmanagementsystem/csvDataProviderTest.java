...
//       Класс Bort
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS,provider.update(allBorts, BORT_CSV_KEY, false));
...
//      Класс  Cargo
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS,provider.update(allCargo, CARGO_CSV_KEY, false));
...
//       Класс ClosedTransport
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS,provider.update(allClosedTransports, CLOSED_TRANSPORT_CSV_KEY, false));
...
//        Класс Container
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS,provider.update(allContainers, CONTAINER_CSV_KEY, false));
...
//        Класс Driver
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS,provider.update(allDrivers, DRIVER_CSV_KEY, false));
...
//        Класс OpenTransport
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS, provider.update(allOpenTransports, OPEN_TRANSPORT_CSV_KEY, false));
        //        Класс Platform
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS, provider.update(allPlatforms, PLATFORM_CSV_KEY, false));
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS, provider.update(allRefrigerators, REFRIGERATOR_CSV_KEY, false));
...
//        Класс Tent
        ...
        for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS, provider.update(allTents, TENT_CSV_KEY, false));
        ...
        List<Traffic> allTraffics = new ArrayList<>();
         for (int i=0; i<=8; i++) {
            ...
            assertEquals(Result.SUCCESS, provider.update(allTraffics, TRAFFIC_CSV_KEY, false));
        ...
        assertEquals(Result.SUCCESS, provider.update(allTransports, TRANSPORT_CSV_KEY, false));
